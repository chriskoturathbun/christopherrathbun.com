...
#ifndef CLAUDEAPPROVE_SWIFT_H
#define CLAUDEAPPROVE_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="ClaudeApprove",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
@class UIApplication;
@class NSData;
SWIFT_CLASS("_TtC13ClaudeApprove11AppDelegate")
...
SWIFT_CLASS("_TtC13ClaudeApprove19NotificationManager")
...
SWIFT_CLASS("_TtC13ClaudeApprove12SettingsSync")
