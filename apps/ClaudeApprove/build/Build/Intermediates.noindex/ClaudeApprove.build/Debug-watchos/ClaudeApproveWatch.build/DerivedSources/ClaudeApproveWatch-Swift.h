...
#ifndef CLAUDEAPPROVEWATCH_SWIFT_H
#define CLAUDEAPPROVEWATCH_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="ClaudeApproveWatch",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC18ClaudeApproveWatch19NotificationManager")
...
SWIFT_CLASS("_TtC18ClaudeApproveWatch12SettingsSync")
@interface SettingsSync : NSObject <WCSessionDelegate>
...
@class NSData;
SWIFT_CLASS("_TtC18ClaudeApproveWatch16WatchAppDelegate")
